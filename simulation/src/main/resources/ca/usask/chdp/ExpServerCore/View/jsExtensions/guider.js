...
var guider = (function () {
   var guider = {
      ...
      _htmlSkeleton: [
         "<div class='guider'>", "  <div class='guider_content'>",
         "    <h1 class='guider_title'></h1>", "    <p class='guider_description'></p>",
         "    <div class='guider_buttons'>", "    </div>", "  </div>",
         "  <div class='guider_arrow'>", "  </div>", "</div>"].join(""),
      ...
      _addButtons: function (myGuider) {
         ...
         for (var i = myGuider.buttons.length - 1; i >= 0; i--) {
            ...
            if (typeof thisButton.idString !== "undefined" && thisButton.idString !== null) {
               thisButtonElem.attr("id", thisButton.idString);
            }
      ...
      _attach: function (myGuider) {
         ...
         if (!_.has(myGuider, "attachTo")) {
            return;
         }

         // test to make sure there is an element to actually attach to.
         // but if this is overlayed, it can be null.
         if (myGuider.attachTo !== null && $(myGuider.attachTo).length == 0) {
            console.error("Could not find element to attach to: " + myGuider.attachTo + " for guider: " + myGuider.id);
         }
